	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf_oj':
				...
				addOffset('sad', 873, -15);
				addOffset('danceLeft', 875, -9);
				addOffset('danceRight', 875, -9);
			...
			case 'oj':
				frames = Paths.getSparrowAtlas('plasma/oj_assets');
				...
				addOffset('idle',0,-15);
				addOffset('singUP',65,4);
				addOffset("singRIGHT",34,-15);
				addOffset("singLEFT",73,-15);
				addOffset("singDOWN",41,-62);

				playAnim('idle');
				
			case 'sansoj':
				frames = Paths.getSparrowAtlas('plasma/sans_assets');
				animation.addByPrefix('idle', "idle", 24, false);
				animation.addByPrefix('singUP', "up", 24, false);
				animation.addByPrefix('singRIGHT', "right", 24, false);
				animation.addByPrefix('singLEFT', "left", 24, false);
				animation.addByPrefix('singDOWN', "down", 24, false);
				animation.addByPrefix('sans', "SANS", 24, false);
				animation.addByPrefix('no', "no", 24, false);

				addOffset('idle',0,-30);
				addOffset('singUP',133,23);
				addOffset("singRIGHT",112,-41);
				addOffset("singLEFT",140,-31);
				addOffset("singDOWN",85,-96);
				addOffset("sans",-10,-30);
				addOffset("no",68,-15);
